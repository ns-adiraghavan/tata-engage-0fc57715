...
const ERAS = [
  { id: "era-roots",    label: "Roots"      },
  { id: "era-growth",   label: "Growth"     },
  { id: "era-digital",  label: "Digital"    },
  { id: "era-scale",    label: "At Scale"   },
...
const MILESTONES = [
  // ERA: ROOTS
  {
    ...
    body: "Tata Engage is born with just 4 Tata companies participating. The idea: make volunteering a structured, scalable part of Tata Group culture — not an afterthought.",
    stat: "4 companies",
    statLabel: "in first year",
    colour: B_INDIGO,
  ...
  },
  {
    ...
    body: "Participation triples. The first cross-company volunteering events emerge — Tata employees from different subsidiaries working side by side in communities for the first time.",
    stat: "12 companies",
    statLabel: "now engaged",
    colour: B_INDIGO,
  ...
  // ERA: GROWTH
  {
    ...
    year: "2010",
    title: "TVW Is Born",
    body: "The first Tata Volunteering Week launches — a concentrated 4-week burst of volunteering that instantly becomes the flagship event of the year. 8,000 volunteers participate in Year 1.",
    stat: "8,000",
    statLabel: "volunteers in Year 1",
    colour: B_YELLOW,
  ...
  },
  {
    era: "era-growth",
    year: "2013",
    title: "Families Join the Movement",
    body: "The programme expands to include family members of Tata employees — recognising that the spirit of service doesn't stop at the office door. Participation surges.",
    stat: "25,000+",
    statLabel: "volunteers across editions",
    colour: B_YELLOW,
  ...
  },
  {
    era: "era-growth",
    year: "2015",
    title: "Retirees Are Welcomed",
    body: "Retired Tata employees are formally included in the programme — their decades of experience now channelled into community service. The Tata family, across all generations.",
    stat: "30,000+",
    statLabel: "total volunteer pool",
    colour: B_YELLOW,
    photo: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&q=80&w=800&h=500",
    tag: "Milestone",
  },
  // ERA: DIGITAL
  {
    ...
    year: "2015",
    title: "Going Digital",
    body: "TataEngage launches its first dedicated digital platform — connecting volunteers with NGOs online for the first time. Applications, tracking, and certificates all move onto a single system.",
    stat: "1 platform",
    statLabel: "for the whole Tata Group",
    colour: B_TEAL,
  ...
  },
  {
    era: "era-digital",
    year: "2018",
    title: "ProEngage Launches",
    body: "Skill-based volunteering arrives. ProEngage lets professionals donate their expertise — not just their time — to NGO projects in HR, finance, IT, and more. Duration: 1–6 months.",
    stat: "200+",
    statLabel: "skill-based projects in Year 1",
    colour: B_TEAL,
  ...
  // ERA: SCALE
  {
    ...
    body: "When the pandemic hits India, TataEngage mobilises 15,000 volunteers in 72 hours. Food kits, medical supplies, digital literacy sessions — the platform proves it can respond to a crisis at national scale.",
    stat: "15,000",
    statLabel: "volunteers in 72 hours",
    colour: B_RED,
  ...
  },
  {
    ...
    body: "The One Tata Response Framework is formalised — a structured system for rapid volunteer deployment during natural disasters. Assam floods, Kerala relief, cyclone response: the cadre is ready.",
    stat: "48hrs",
    statLabel: "deployment window",
    colour: B_RED,
  ...
  },
  {
    era: "era-scale",
    year: "2022",
    title: "100 Companies Strong",
    body: "TataEngage reaches a landmark — every major Tata company is now on the platform. From TCS to Titan, from Tata Motors to Tata Power: one volunteering community, one unified voice.",
    stat: "100+",
    statLabel: "Tata companies on platform",
    colour: B_BLUE,
  ...
  // ERA: TODAY
  {
    ...
    year: "2024",
    title: "50,000 Strong",
    body: "The volunteer community crosses 50,000 active members. 85 NGO partners. 1,200+ ProEngage projects completed. 2.5 million volunteer hours logged. What started with 4 companies now spans a nation.",
    stat: "50,000+",
  ...
  },
  {
    ...
    body: "TataEngage relaunches with AI-powered project matching, a new Disaster Response cadre, real-time SPOC dashboards, and a rebuilt volunteer experience — designed for the next 15 years of impact.",
    stat: "Next chapter",
