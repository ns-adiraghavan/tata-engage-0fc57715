  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#f5f5fa" }}>
      ...
      <div style={{ backgroundColor: ACCENT_NAVY, position: "relative", overflow: "hidden", padding: "28px 64px", ...TEXTURE }}>
        {/* Radial glow */}
        <div style={{ position: "absolute", top: -80, right: -80, width: 340, height: 340, background: "radial-gradient(circle, rgba(62,126,176,0.22) 0%, transparent 70%)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: -60, left: -40, width: 220, height: 220, background: "radial-gradient(circle, rgba(51,51,153,0.18) 0%, transparent 70%)", pointerEvents: "none" }} />
        ...
        <div style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32 }}>
          ...
          <div style={{ flexShrink: 0 }}>
            <button
              ...
              style={{ fontSize: 11, color: "rgba(255,255,255,0.35)", background: "none", border: "none", cursor: "pointer", marginBottom: 12, display: "block", letterSpacing: "0.5px" }}
            >
              ← Back to Home
            </button>
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: active
                        ? `0 0 0 4px ${B_TICKER}22, 0 8px 24px rgba(0,0,0,0.1)`
                        : "0 1px 4px rgba(0,0,0,0.04)",
                    }}
                    onMouseEnter={e => {
                      if (!active) {
                        e.currentTarget.style.borderColor = B_TICKER;
                        e.currentTarget.style.boxShadow = `0 6px 20px rgba(62,126,176,0.14)`;
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      backgroundColor: active ? "rgba(255,255,255,0.12)" : `${B_TICKER}18`,
                      color: active ? "#fff" : B_TICKER,
                      flexShrink: 0,
                    }}>
                      <role.icon size={23} />
                    </div>
                    ...
                    <div>
                      <h4 style={{ fontWeight: 700, fontSize: 14, color: active ? "#fff" : ACCENT_NAVY, marginBottom: 6 }}>
                        {role.title}
                      </h4>
                      <p style={{ fontSize: 11.5, color: active ? "rgba(255,255,255,0.55)" : "#94a3b8", lineHeight: 1.55, margin: 0 }}>
                        {role.desc}
                      </p>
                    </div>

                    {active && (
                      <div style={{ fontSize: 11, fontWeight: 700, color: B_YELLOW, letterSpacing: "0.3px", marginTop: 2 }}>
                        Selected ✓
                      </div>
                    )}
                  </motion.div>
            ...
            <div style={{ textAlign: "center", marginTop: 32 }}>
              <p style={{ fontSize: 13.5, color: "#94a3b8", margin: 0 }}>
                ...
                <button
                  ...
                  style={{ fontWeight: 700, color: B_TICKER, background: "none", border: "none", cursor: "pointer", textDecoration: "underline" }}
                >
                  Login here
                </button>
              </p>
