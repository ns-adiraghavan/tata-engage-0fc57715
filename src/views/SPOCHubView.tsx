...
import { ROHAN_DESAI, COMMUNITY_TESTIMONIALS, PENDING_APPROVALS_DATA } from "@/data/mockData";
    ...
    <div className="pt-20 min-h-screen bg-white">
      ...
      <div className="px-6 md:px-12 pt-8 pb-0 max-w-7xl mx-auto">
        <div className="relative rounded-3xl overflow-hidden" style={{ minHeight: 560 }}>
          ...
          />
          {/* Deeper indigo-tinted gradient for the SPOC authority tone */}
          ...
          {/* Dashboard CTA — bottom right, indigo accent for SPOC authority */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-4">
            <div className="lg:col-span-7 relative rounded-2xl overflow-hidden min-h-[340px] flex flex-col justify-between p-8 transition-all duration-700"
              ...
              <div className="absolute top-0 left-0 w-1 h-full transition-colors duration-700" style={{ backgroundColor: prog.accent }} />
              ...
              <div className="relative z-10 flex gap-3 mt-6">
                <button onClick={() => navigate("spoc-dashboard")}
      ...
      <section className={`${secBg(2)} py-10 px-6 md:px-12`}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute top-[36px] left-10 right-10 hidden lg:block" style={{ borderTop: "2px dashed #CBD5E1" }} />
                ...
                <div key={m.year} className="flex flex-col items-center text-center group">
                  <div className="relative z-10 mb-3">
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2">
                      <span className="text-[10px] font-black px-2 py-0.5 rounded-full text-white whitespace-nowrap" style={{ backgroundColor: m.colour }}>{m.year}</span>
                    </div>
                  </div>
                  <div className="mt-4">
